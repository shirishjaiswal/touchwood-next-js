...
import InputSelection from "@/app/home/configuration/profile/[...slug]/components/field/input-selection";
import CreatableDropdown, {
  CreatableDropdownOnChangeEvent,
} from "@/components/ui/dropdown/creatable-dropdown";
import Duration from "@/components/ui/input/duration";
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 ">
            ...
            {selectedInputField === "checkbox" && (
              <Toggle
                ...
                id="field-multiple"
                name="field-multiple"
                aria-label="field-multiple"
                data-testid="field-multiple"
                mainContainerStyles="w-full flex gap-4 items-center"
              />
            )}
          </div>
