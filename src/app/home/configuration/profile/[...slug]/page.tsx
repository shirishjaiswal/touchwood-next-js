...
import GroupContentRender from "@/app/admin/configuration/profile/[...slug]/components/group/group-content-render";
...
async function Page({ params }: { params: { slug: string[] } }) {
  ...
  if (tabsStatus !== 200 || !tabs) {
    toast.error(tabsError || "Failed to load tabs.");
    return null;
  }
